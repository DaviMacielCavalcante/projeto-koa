...
const styles = StyleSheet.create({
    ...
    botaoAdicionar: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.tealDark, alignItems: 'center', justifyContent: 'center' },
    subtitulo: { fontFamily: fonts.body, fontSize: sizes.bodySm, color: colors.inkSoft, paddingHorizontal: 20, lineHeight: 20, paddingBottom: 12 },
    vazio: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 40, gap: 12 },
    vazioIcone: { width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(31,122,122,0.1)', alignItems: 'center', justifyContent: 'center' },
    ...
    card: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.white, borderRadius: 18, padding: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
    cardIcone: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.creamDeep, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    cardInfo: { flex: 1 },
    ...
    btnVer: { width: 34, height: 34, borderRadius: 17, backgroundColor: colors.tealDark, alignItems: 'center', justifyContent: 'center' },
    btnCamera: { width: 34, height: 34, borderRadius: 17, backgroundColor: colors.creamDeep, alignItems: 'center', justifyContent: 'center' },
    btnDeletar: { width: 34, height: 34, borderRadius: 17, backgroundColor: 'rgba(155,27,27,0.08)', alignItems: 'center', justifyContent: 'center' },
    modalFundo: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
    modalCard: { backgroundColor: colors.creamLight, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 24, gap: 12 },
    ...
    input: { backgroundColor: colors.white, borderRadius: 14, padding: 14, fontFamily: fonts.bodyMedium, fontSize: sizes.body, color: colors.ink, borderWidth: 1, borderColor: colors.creamDeep },
    btnConfirmar: { backgroundColor: colors.tealDark, borderRadius: 30, paddingVertical: 14, alignItems: 'center' },
